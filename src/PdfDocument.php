...
class PdfDocument
{
    ...
    public function output()
    {
        ...
        // If a footer view is provided, render it and save it to a temporary file.
        ...
        // Include the footer template path if it exists
        ...
        // Clean up the temporary footer file if it was created
